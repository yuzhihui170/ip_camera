...
void compress_begin(Encoder *en, int width, int height) {
	...
	CLEAR(en->param, sizeof(x264_param_t));
	CLEAR(en->picture, sizeof(x264_picture_t));
	...
	en->param->b_annexb = 1;
	en->param->i_csp = X264_CSP_I420; //X264_CSP_I422; //设置压缩时的图片格式
	

	en->picture->img.i_csp = X264_CSP_I420;//X264_CSP_I422; //设置如何的图片格式 两者要一致
